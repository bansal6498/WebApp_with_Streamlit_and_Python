...
st.markdown("This application is a streamlit dashboard used to analyze Motor vehicle collison in NYC")
...
st.header("How many collison occur during a during a time of Day?")
hour = st.slider("hour to Look at", 0,23)
data = data[data['date/time'].dt.hour ==hour]

st.markdown("Vehicle Collison between %i:00 and %i:00" % (hour, (hour + 1)  %24))
